                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                                ...
                                messages = {{
                                    required: 'Required! ',
                                    minLength: 'Must be grerater than 2 characters! ',
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    className="form-control" validators={{required, minLength: minLength(3), maxLength: maxLength(15), isNumber}} ></Control.text>
                                    <Errors className="text-danger" model=".telnum" show="touched" 
                                    messages = {{
                                        required: 'Required! ',
                                        minLength: 'Must be grerater than 2 numbers! ',
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    className="form-control" validators={{required, validEmail}}></Control.text>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" id="message" className="form-control" name="message" rows="12"></Control.textarea>
                                </Col>
                            </Row>
                            <Row className="form-group">
