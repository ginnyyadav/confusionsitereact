...
class Header extends Component {
    ...
    handleLogin(event) {
        this.toggleModal();
        alert("Username:" + this.user.value + "Password:" + this.password.value
           ...
           <ModalBody>
               <Form onSubmit={this.handleLogin}>
                   <FormGroup>
                       ...
                       <Input type="text" id="username" name="username" innnerRef={(input) => this.username = input}></Input>
                   </FormGroup>
                   <FormGroup>
                       <Label htmlFor="password">Password</Label>
                       <Input type="text" id="password" name="password" innnerRef={(input) => this.password = input}></Input>
                   </FormGroup>
                   <FormGroup check>
                       <Input type="checkbox" name="remember" innnerRef={(input) => this.remember = input}></Input>
                       Remember me
                   </FormGroup>
